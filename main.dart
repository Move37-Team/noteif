...
class _HomePageState extends State<HomePage> {
  ...
  String language = 'fa';
  Map strings = {
    'fa':{'title':'ثبت یادداشت های مهم شما در نوتیفیکیشن :)','main':'متن یادداشت','button':'ثبت یادداشت','switch':'نمایش دادن نوتیفیکیشن'},
    'eng':{'title':'(: Recording your important notes in notifications ','main':'Main Text','button':'Record Note','switch':'Show the Notification'},
  ...
  Widget build(BuildContext context) {
    ...
    final noteTextField = Padding(
      ...
      child: TextField(
        ...
        textDirection: language == 'fa' ? TextDirection.rtl : TextDirection.ltr,
        textAlign: language == 'fa' ? TextAlign.right : TextAlign.left,
        minLines: 6,
        cursorColor: AppColors.bondiBlue,
        keyboardType: TextInputType.multiline,
        maxLines: null,
        decoration: new InputDecoration(
          labelText: strings[language]['main'],
    ...
    final saveNoteButton = Padding(
      ...
      child: Center(child: materialButton(strings[language]['button'], setNote)),
    );
